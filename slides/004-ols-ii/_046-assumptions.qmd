...
[1.]{.note} [Linearity:]{.hi} The population relationship is .hi[linear in parameters] with an additive error term.
...
[1.]{.note} [Linearity:]{.hi} The population relationship is [_linear in parameters_]{.note} with an additive error term.

. . .

[2.]{.note} [Sample Variation:]{.hi} There is variation in $X$.
...
[3.]{.note} [Exogeniety:]{.hi} The $X$ variable is [exogenous]{.note} 
...
## Exogeniety (A3.) {data-visibility="uncounted"}
...
[4.]{.note} [Homoskedasticity:]{.hi} The error term has the same variance for each value of the independent variable 
...
[5.]{.note} [Non-autocorrelation:]{.hi} The values of error terms have independent distributions 
