...
Continuous distribution where $x_i$ can take the value of any real number (${\mathbb{R}}$)
...
[Rule 2:]{.note} The probability that the random variable takes a value within $[x_i,x_j]$ range, where $x_i \neq x_j$, is the area under $p(x)$ between those two values 
